  ...
  return (
    <div className="relative">
      <button
        ...
        className={cn(
          "notesvault-focus-ring flex size-8 items-center justify-center border border-border text-muted-foreground transition-colors duration-[var(--motion-standard)] ease-[var(--motion-ease-standard)]",
          isOpen
      ...
      {isOpen ? (
        ...
        >
          <button
            className="notesvault-focus-ring flex w-full items-center gap-2.5 px-3 py-2 text-left text-xs transition-colors duration-[var(--motion-standard)] ease-[var(--motion-ease-standard)] hover:bg-secondary"
          ...
          <button
            className="notesvault-focus-ring flex w-full items-center gap-2.5 px-3 py-2 text-left text-xs text-danger transition-colors duration-[var(--motion-standard)] ease-[var(--motion-ease-standard)] hover:bg-danger-subtle"
